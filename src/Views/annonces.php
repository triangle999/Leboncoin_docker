                    ...
                    <div class="col-3">
                        ...
                        <div class="card">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item"><p class="d-inline rounded p-1"><?= $info['a_price'] ?> €</p></li>
                                <li class="list-group-item"><p class="blue rounded fs-6 p-1">Livraison possible</p></li>
                                <li class="list-group-item"><p class="card-text"><small class="text-body-secondary"><?= $info['a_publication'] ?></small></p></li>
                            </ul>
                        </div>
